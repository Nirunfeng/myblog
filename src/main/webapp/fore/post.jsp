...
<nav class="navbar fixed-top navbar-toggleable-md navbar-light" id="mainNav">
    <div class="container">
        ...
        <a class="navbar-brand page-scroll" href="../index.jsp">Start Bootstrap</a>
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="${pageContext.request.contextPath}/about.do">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="post.jsp">Sample Post</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="contact.jsp">Contact</a>
                </li>
            </ul>
        </div>
    </div>
